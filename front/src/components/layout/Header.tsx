	...
	renderLanguageFlag() {
			...
			menu_items.push(
				<Menu.Item key={"language-" + locale} onClick={() => this.changeLanguage(locale)}>
					<a className="flex items-center">
						<img id="language-flag" className="mr-2 h-8" src={"/assets/images/flags/" + LANGUAGE_MAP[locale].flag + ".png"}/>
		...
		return (
			<Dropdown overlay={menu} trigger={["click"]} placement="bottomRight">
				<img id="language-flag" className="ml-4 h-8 cursor-pointer" src={"/assets/images/flags/" + flag + ".png"}/>
			</Dropdown>
		);
	}
